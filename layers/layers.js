...
lyr_ESRI_0.setVisible(true);lyr_amphoe_1.setVisible(true);lyr_village_2.setVisible(true);lyr_water_way_3.setVisible(true);
var layersList = [lyr_ESRI_0,lyr_amphoe_1,lyr_village_2,lyr_water_way_3];
...
lyr_village_2.set('fieldImages', {'NRD_CODE': 'TextEdit', 'VILL_CODE': 'TextEdit', 'VILL_NAM_T': 'TextEdit', 'PROV_CODE': 'TextEdit', });
